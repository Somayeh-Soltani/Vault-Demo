...
vault write data_protection/transit/encrypt/customer-key plaintext=$(echo -n "my secret data" | base64)

#vault write data_protection/transit/encrypt/archive-key plaintext=$(base64 <<< "my secret data")
vault write data_protection/transit/encrypt/archive-key plaintext=$(echo -n "my secret data" | base64)
